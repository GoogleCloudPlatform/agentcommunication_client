...
TEST(JwtTest, CanGetValuesFromTokenPayloadWithKeysFromValidToken) {
...
TEST(JwtTest, EmptyKeysInput) {
  absl::StatusOr<std::string> empty_keys = GetValueFromTokenPayloadWithKeys(
      std::string(kInvalidToken), {});
  ...
  absl::StatusOr<std::string> empty_token = GetValueFromTokenPayloadWithKeys(
      "", {"aud"});
...
TEST(JwtTest,
  ...
  absl::StatusOr<std::string> audience = GetValueFromTokenPayloadWithKeys(
      std::string(kInvalidToken), {"aud"});
